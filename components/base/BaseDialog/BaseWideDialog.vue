<template>
    ...
    >
        <v-card :tile="true">
            ...
            <v-expand-transition>
                <div class="mx-2">
                    <v-card-text class="alt-scrollbar" :class="`card-container ${!!tmpl.overflow ? tmpl.overflow : 'overflow-auto'}`">
                        <v-row>
                            <v-col :cols="!!tmpl.cols_left ? tmpl.cols_left : 4">
                            ...
                            <v-col :cols="!!tmpl.cols_right ? tmpl.cols_right : 8">
